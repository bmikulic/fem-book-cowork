...
| Dim line cuts through a node label that "should fit" | Forgot to convert real-pt label width into scaled TikZ units when figure uses `x=Ncm` | Estimate `(chars × 0.20 cm) / x_scale_cm`; push dim line past that span plus margin |
